...
// 3. DATABASE SEEDING (Updated with Error Handling)
using (var scope = app.Services.CreateScope())
{
    try
    {
    ...
    catch (Exception ex)
    {
        ...
        logger.LogError(ex, "An error occurred while seeding the database (AWS Connection).");
    }
}
